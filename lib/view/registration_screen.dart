...
//       if (existing != null) {
//         // Check for exact match (your current logic)
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Softroniics Scratch & Win'),
//         actions: [
//           TextButton(
...
//                               : const Text('Continue to Scratch'),
//                         ),
//                       ),
//                     ],
//                   ),
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF0F0F0), // same bg as 2nd code
